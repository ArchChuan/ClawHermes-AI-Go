...
replace (
	go.opentelemetry.io/contrib/instrumentation/github.com/gin-gonic/gin/otelgin => go.opentelemetry.io/contrib/instrumentation/github.com/gin-gonic/gin/otelgin v0.47.0
